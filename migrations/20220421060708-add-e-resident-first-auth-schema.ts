            ...
            values: {
                ...
                messages: {
                    ...
                    face_recognition_message_not_enough_light:
                        'authUrl.v3.face-recognition.Android.face_recognition_message_not_enough_light', // eslint-disable-line max-len
                    face_recognition_message_too_much_light: 'authUrl.v3.face-recognition.Android.face_recognition_message_too_much_light', // eslint-disable-line max-len
                    face_recognition_message_take_phone_aligned_to_head:
                        'authUrl.v3.face-recognition.Android.face_recognition_message_take_phone_aligned_to_head', // eslint-disable-line max-len
                    face_recognition_message_looks_like_cheater:
                        'authUrl.v3.face-recognition.Android.face_recognition_message_looks_like_cheater', // eslint-disable-line max-len
                    face_recognition_message_more_than_one_face_in_frame:
                        'authUrl.v3.face-recognition.Android.face_recognition_message_more_than_one_face_in_frame', // eslint-disable-line max-len
                    face_recognition_message_look_strait_to_camera:
                        'authUrl.v3.face-recognition.Android.face_recognition_message_look_strait_to_camera', // eslint-disable-line max-len
                    face_recognition_message_checking_you_are_real_person:
                        'authUrl.v3.face-recognition.Android.face_recognition_message_checking_you_are_real_person', // eslint-disable-line max-len
